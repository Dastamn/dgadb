...
class _gnn_lib(object):
    ...
    def _prepare_graph(self, graph_list, is_directed=0):
        ...
        self.lib.PrepareBatchGraph(
            self.batch_graph_handle,
            len(graph_list),
    ...
    def PrepareSparseMatrices(self, graph_list, is_directed=0):
        ...
        self.lib.PrepareSparseMatrices(
            self.batch_graph_handle, ctypes.cast(idx_list, ctypes.c_void_p), ctypes.cast(val_list, ctypes.c_void_p)
        )
