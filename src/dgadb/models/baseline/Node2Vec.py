...
class n2vModel:
    ...
    def __init__(
        ...
        self.num_epochs = hyperparams.get("num_epochs", 20)
        ...
        self.num_workers = hyperparams.get("num_workers", 4)
    ...
    def setup(self, temporal_graph: TemporalGraph) -> None:
        ...
        self.loader = self.encoder.loader(batch_size=self.batch_size, shuffle=True, num_workers=self.num_workers)
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.num_epochs):
            ...
            for pos_rw, neg_rw in self.loader:
                ...
                loss = self.encoder.loss(pos_rw.to(self.device), neg_rw.to(self.device))
                loss.backward()
                self.optimizer.step()
    ...
    def inference(self, split: str = "test"):
        ...
        split_labels = self.labels[split_mask_map[split]].to(probs.device).float()
        return probs, split_labels
