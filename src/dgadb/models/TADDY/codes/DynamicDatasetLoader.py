...
class DynamicDatasetLoader(dataset):
    ...
    def load(self):
        ...
        print("Nbr nodes", nb_nodes)
        print("Nbr edges", nb_edges)
        print("Train size", train_size)
        print("Test size", test_size)

        print("rows", len(rows), len(rows[0]))
        print("cols", len(cols), len(cols[0]))
        ...
        print("A")
        print(len(adjs), len(adjs[0]))
        print("S")
        print(len(eigen_adjs), len(eigen_adjs[0]))
        print("index_id_map")
        print(len(index_id_map))
