...
class BaseADModel(Generic[BaseADModelComponentsType], ABC):
    ...
    def run_inference(
        ...
        """Run inference over a snapshot loader, optionally profiling each step.

        Args:
            loader: Snapshot loader providing the inference inputs.
        ...
        Returns:
            Tuple of (edge_labels, edge_scores) concatenated across all snapshots.
        """
        import time
